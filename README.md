...
<h1 align="center">sview <br><span style="font-weight:400;font-size:0.5em;">Built for jailbroken Amazon Echo Shows to display Spotify now-playing info</span></h1>
...
- Optimized for the Echo Show form factor; expects a jailbroken environment.
